...
class Agent():
    ...
    def process_experience(self, experience: AttrDict):
        ...
        self.config.env_steps += self.env.num_envs if hasattr(
            self, 'env') else 1
...
class Module(object):
    ...
    def __init__(self, module_name: str,
        ...
        # Optionally used to log arguments to each module (Called by Logger)
        self.config_spec = locals
    ...
    def verify_agent_compatibility(self):
        ...
        for module in self.required_agent_modules:
            assert hasattr(
                self.agent, module), 'Agent is missing module {}'.format(module)
